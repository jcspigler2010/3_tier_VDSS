...
output "ext_bigip" {
  ...
  value       = module.aws-gov-west-vdss-1.ext_bigip
...
output "ext_f5_mgmt_public_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.ext_f5_mgmt_public_ip
...
output "ext_f5_mgmt_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.ext_f5_mgmt_private_ip
...
output "ext_f5_ext_public_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.ext_f5_ext_public_ip
...
output "ext_f5_ext_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.ext_f5_ext_private_ip
...
output "ext_f5_inspect_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.ext_f5_inspect_private_ip
...
output "int_bigip" {
  ...
  value       = module.aws-gov-west-vdss-1.int_bigip
}

output "int_f5_mgmt_public_ip" {

  value       = module.aws-gov-west-vdss-1.int_f5_mgmt_public_ip
...
output "int_f5_mgmt_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.int_f5_mgmt_private_ip
...
output "int_f5_inspect_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.int_f5_inspect_private_ip
...
output "int_f5_tenant_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.int_f5_tenant_private_ip
...
output "mgmt_bigip" {
  ...
  value       = module.aws-gov-west-vdss-1.mgmt_bigip
...
output "mgmt_f5_mgmt_public_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.mgmt_f5_mgmt_public_ip
...
output "mgmt_f5_mgmt_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.mgmt_f5_mgmt_private_ip
...
output "mgmt_f5_ext_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.mgmt_f5_ext_private_ip
...
output "mgmt_f5_internal_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.mgmt_f5_internal_private_ip
...
output "pan_info" {
  ...
  value       = module.aws-gov-west-vdss-1.pan_info
...
output "pan_mgmt_public_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.pan_mgmt_public_ip
...
output "pan_mgmt_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.pan_mgmt_private_ip

}

output "pan_inspect_ext_private_ip" {

  value       = module.aws-gov-west-vdss-1.pan_inspect_ext_private_ip
...
output "pan_inspect_int_private_ip" {
  ...
  value       = module.aws-gov-west-vdss-1.pan_inspect_int_private_ip
